...
- 3D-printed chassis parts. The resin front cover exposes the LCD and provides button mounting holes. The PLA container holds the microcontroller, protoboard, and wiring. Both `.stl` and `.step` files are provided in this repository for the front cover and container.
